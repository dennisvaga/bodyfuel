...
import { productColumns } from "../../products/components/table/productColumns";
...
const CollectionForm = ({ collection }: collectionProps) => {
  const { form, formHeading, products, rowSelection, setRowSelection, onSubmit } =
      ...
      <Card>
        <CardContent>
          ...
          <EntitySelection
            ...
            entityData={products}
            columns={productColumns.filter((col: any) =>
