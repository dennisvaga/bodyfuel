...
import { decryptToken } from "./utils/authUtils.js";
...
export async function authenticatedAdmin(
  ...
  try {
    ...
    if (typeof payload !== "object" || !("role" in payload) || payload.role !== "ADMIN") {
    ...
    sendResponse(res, 401, { success: false, message: "Invalid authentication" });
  }
}
